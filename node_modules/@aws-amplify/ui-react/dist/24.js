...
function () {
  function AmplifyPhotoPicker(hostRef) {
    ...
    this.headerTitle = _Translations_71acc661_js__WEBPACK_IMPORTED_MODULE_3__["T"].PHOTO_PICKER_TITLE;
    /** Header Hint value in string */

    this.headerHint = _Translations_71acc661_js__WEBPACK_IMPORTED_MODULE_3__["T"].PHOTO_PICKER_HINT;
    /** Placeholder hint that goes under the placeholder image */

    this.placeholderHint = _Translations_71acc661_js__WEBPACK_IMPORTED_MODULE_3__["T"].PHOTO_PICKER_PLACEHOLDER_HINT;
    /** Picker button text as string */

    this.buttonText = _Translations_71acc661_js__WEBPACK_IMPORTED_MODULE_3__["T"].PHOTO_PICKER_BUTTON_TEXT;
