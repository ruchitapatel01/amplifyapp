...
function () {
  function AmplifyCodeField(hostRef) {
    ...
    this.label = _Translations_71acc661_js__WEBPACK_IMPORTED_MODULE_3__["T"].CODE_LABEL;
    /** Used for the placeholder label */

    this.placeholder = _Translations_71acc661_js__WEBPACK_IMPORTED_MODULE_3__["T"].CODE_PLACEHOLDER;
...
function () {
  function AmplifyEmailField(hostRef) {
    ...
    this.label = _Translations_71acc661_js__WEBPACK_IMPORTED_MODULE_3__["T"].EMAIL_LABEL;
    /** Used for the placeholder label */

    this.placeholder = _Translations_71acc661_js__WEBPACK_IMPORTED_MODULE_3__["T"].EMAIL_PLACEHOLDER;
    /** The required flag in order to make an input required prior to submitting a form */
...
function () {
  function AmplifyPasswordField(hostRef) {
    ...
    this.label = _Translations_71acc661_js__WEBPACK_IMPORTED_MODULE_3__["T"].PASSWORD_LABEL;
    /** Used for the placeholder label */

    this.placeholder = _Translations_71acc661_js__WEBPACK_IMPORTED_MODULE_3__["T"].PASSWORD_PLACEHOLDER;
    /** The required flag in order to make an input required prior to submitting a form */
...
function () {
  function AmplifyPhoneField(hostRef) {
    ...
    this.label = _Translations_71acc661_js__WEBPACK_IMPORTED_MODULE_3__["T"].PHONE_LABEL;
    /** Used for the placeholder label */

    this.placeholder = _Translations_71acc661_js__WEBPACK_IMPORTED_MODULE_3__["T"].PHONE_PLACEHOLDER;
    /** The required flag in order to make an input required prior to submitting a form */
...
function () {
  function AmplifyUsernameField(hostRef) {
    ...
    this.label = _Translations_71acc661_js__WEBPACK_IMPORTED_MODULE_3__["T"].USERNAME_LABEL;
    /** Used for the placeholder label */

    this.placeholder = _Translations_71acc661_js__WEBPACK_IMPORTED_MODULE_3__["T"].USERNAME_PLACEHOLDER;
    /** The required flag in order to make an input required prior to submitting a form */
